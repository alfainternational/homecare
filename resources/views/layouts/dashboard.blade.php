    ...
    <aside class="fixed inset-y-0 right-0 z-30 flex flex-col w-64 bg-white border-l border-gray-100 shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:shadow-none"
        ...
        <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 py-4 space-y-1">
            ...
            <a href="{{ url('/dashboard/wallet') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->is('dashboard/wallet') ? 'bg-[#F5A623] text-white shadow' : 'text-gray-600 hover:bg-[#FFF3DC] hover:text-[#F5A623]' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ url('/dashboard/profile') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->is('dashboard/profile') ? 'bg-[#F5A623] text-white shadow' : 'text-gray-600 hover:bg-[#FFF3DC] hover:text-[#F5A623]' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <div class="py-1">
                                <a href="{{ url('/dashboard/profile') }}" class="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 hover:text-[#F5A623]">
