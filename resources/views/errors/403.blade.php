...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
  <div class="text-center px-6">
    <div class="text-9xl font-black text-[#F5A623] mb-4">403</div>
    <div class="text-2xl font-bold text-gray-800 mb-3">غير مصرح لك بالوصول</div>
    <p class="text-gray-500 mb-8 max-w-md mx-auto">ليس لديك صلاحية للوصول إلى هذه الصفحة. تواصل مع المشرف إذا كنت تعتقد أن هذا خطأ.</p>
